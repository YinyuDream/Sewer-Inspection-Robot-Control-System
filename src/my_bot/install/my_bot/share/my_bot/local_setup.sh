...
: ${AMENT_CURRENT_PREFIX:="/home/yinyudream/Desktop/final_design/src/my_bot/install/my_bot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_bot/environment/pythonpath.sh"
