...
def generate_launch_description():
    ...
    bridge = Node(
        ...
        arguments=[
            ...
            '/model/simple_car_v2/joint/drive_wheel_top_joint/cmd_vel@std_msgs/msg/Float64@ignition.msgs.Double',
            '/model/simple_car_v2/joint/drive_wheel_bottom_joint/cmd_vel@std_msgs/msg/Float64@ignition.msgs.Double',
            '/model/simple_car_v2/joint/drive_wheel_left_joint/cmd_vel@std_msgs/msg/Float64@ignition.msgs.Double',
            '/model/simple_car_v2/joint/drive_wheel_right_joint/cmd_vel@std_msgs/msg/Float64@ignition.msgs.Double',
            # Arm control
        ...
        remappings=[
            ('/model/simple_car_v2/joint/drive_wheel_top_joint/cmd_vel', '/simple_car/top_wheel_vel'),
            ('/model/simple_car_v2/joint/drive_wheel_bottom_joint/cmd_vel', '/simple_car/bottom_wheel_vel'),
            ('/model/simple_car_v2/joint/drive_wheel_left_joint/cmd_vel', '/simple_car/left_wheel_vel'),
            ('/model/simple_car_v2/joint/drive_wheel_right_joint/cmd_vel', '/simple_car/right_wheel_vel'),
